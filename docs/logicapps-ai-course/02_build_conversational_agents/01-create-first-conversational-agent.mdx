---
title: 01 - Build your first conversational agentic workflow in Azure Logic Apps
description: Learn how to build a conversational agentic workflow in Azure Logic Apps, connect it to an Azure OpenAI model, and add its first tool.
