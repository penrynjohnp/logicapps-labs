--- 
title: 02 - Debug your conversational agentic workflow in Azure Logic Apps
description: Learn how to monitor and debug a Logic Apps conversational agentic workflow using run history, chat transcripts, tool calls, and model inputs/outputs.
