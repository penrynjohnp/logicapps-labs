---
title: 01 - Build your first autonomous agentic workflow in Azure Logic Apps
description: Learn how to build an autonomous agentic workflow in Azure Logic Apps (Standard), connect it to an Azure OpenAI model or Azure Foundry, and add its first tool.
