--- 
title: 02 - Debug your autonomous agentic workflow in Azure Logic Apps
description: Learn how to monitor and debug a Logic Apps autonomous agentic workflow using run history, tool calls, and model inputs/outputs.
