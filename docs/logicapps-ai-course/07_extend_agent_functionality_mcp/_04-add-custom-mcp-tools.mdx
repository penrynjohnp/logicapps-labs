---
title: 04 - Add Custom MCP tools to your agentic workflow
description: Learn how to add custom connector MCP (Model Context Protocol) tools to Azure Logic Apps agentic workflows using Custom MCP connectors (Azure-hosted MCP servers exposed like custom connectors) including authentication patterns and monitoring.
