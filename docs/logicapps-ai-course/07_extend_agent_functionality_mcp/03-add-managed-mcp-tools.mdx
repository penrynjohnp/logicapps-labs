---
title: 03 - Add Managed MCP tools to your agentic workflow
description: Learn how to add managed MCP (Model Context Protocol) tools to Azure Logic Apps agentic workflows using Managed MCP connectors (Azure-hosted MCP servers exposed like managed APIs) including authentication patterns (app-only vs on-behalf-of) and monitoring.
